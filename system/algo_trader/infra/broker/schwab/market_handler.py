...
from system.algo_trader.infra.broker.schwab.schwab_client import SchwabClient
...
class MarketHandler(SchwabClient):
    ...
    def _send_request(
        ...
        Returns:
            ...
            - response_data: Dict containing response data if successful, None otherwise
    ...
    def get_quotes(self, tickers: list[str]) -> dict[str, Any]:
        ...
        response, _ = self._send_request(url, params)
        if response:
