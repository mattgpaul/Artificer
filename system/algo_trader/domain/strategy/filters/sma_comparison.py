...
from system.algo_trader.domain.strategy.filters.base import BaseComparisonFilter
from system.algo_trader.domain.strategy.filters.core import FilterContext
from system.algo_trader.domain.strategy.studies.moving_average.simple_moving_average import (
    SimpleMovingAverage,
)
