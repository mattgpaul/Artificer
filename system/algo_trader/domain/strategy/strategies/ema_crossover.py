...
from system.algo_trader.domain.strategy.studies.base_study import StudySpec
from system.algo_trader.domain.strategy.studies.moving_average.exponential_moving_average import (
