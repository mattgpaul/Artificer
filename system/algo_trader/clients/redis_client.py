"""Algo-trader Redis client.

This module provides a system-specific wrapper around the infrastructure Redis
client, with helpers for storing Schwab authentication tokens.
"""
