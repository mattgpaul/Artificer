...
from system.algo_trader.clients.influxdb_client import (
    AlgoTraderInfluxDBClient,
    CandleQueryFilters,
    CandleSeriesSpec,
)
...
class TestAlgoTraderInfluxDBClientUnit:
    ...
    def test_get_available_tickers_success(self, mock_getenv, mock_influx_client):
        ...
        mock_result.__getitem__.return_value.unique.return_value.tolist.return_value = [
            "AAPL",
            "MSFT",
            "GOOGL",
        ]
