...
from system.algo_trader.strategy.executor import (
    create_strategy,
    display_signals,
    execute_strategy,
    generate_journal,
...
class TestCreateStrategy:
    ...
    @patch("system.algo_trader.strategy.executor.SMACrossoverStrategy")
...
class TestDisplaySignals:
    ...
    @patch("system.algo_trader.strategy.executor.format_signal_summary")
...
class TestExecuteStrategy:
    ...
    @patch("system.algo_trader.strategy.executor.run_strategy_for_tickers")
    @patch("system.algo_trader.strategy.executor.display_signals")
    @patch("system.algo_trader.strategy.executor.datetime")
    ...
    @patch("system.algo_trader.strategy.executor.create_strategy")
    @patch("system.algo_trader.strategy.executor.run_strategy_for_tickers")
    @patch("system.algo_trader.strategy.executor.handle_empty_signals")
    @patch("system.algo_trader.strategy.executor.datetime")
    ...
    @patch("system.algo_trader.strategy.executor.create_strategy")
    @patch("system.algo_trader.strategy.executor.run_strategy_for_tickers")
    @patch("system.algo_trader.strategy.executor.generate_journal")
    @patch("system.algo_trader.strategy.executor.display_signals")
    @patch("system.algo_trader.strategy.executor.datetime")
