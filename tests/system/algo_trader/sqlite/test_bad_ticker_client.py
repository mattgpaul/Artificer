...
class TestBadTickerClientInitialization:
    ...
    def test_initialization_default_config(self, mock_sqlite, mock_logger):
    ...
    def test_initialization_with_env_var(self, mock_sqlite, mock_logger):
    ...
    def test_initialization_creates_table(self, mock_sqlite, mock_logger):
...
class TestBadTickerClientTableCreation:
    ...
    def test_create_table_success(self, mock_sqlite, mock_logger):
    ...
    def test_create_table_failure(self, mock_sqlite, mock_logger):
...
class TestBadTickerClientOperations:
    ...
    def test_log_bad_ticker_success(self, mock_sqlite, mock_logger):
    ...
    def test_log_bad_ticker_failure(self, mock_sqlite, mock_logger):
    ...
    def test_get_bad_tickers_success(self, mock_sqlite, mock_logger):
    ...
    def test_get_bad_tickers_failure(self, mock_sqlite, mock_logger):
    ...
    def test_is_bad_ticker(self, mock_sqlite, mock_logger, found, expected):
    ...
    def test_is_bad_ticker_error(self, mock_sqlite, mock_logger):
    ...
    def test_remove_bad_ticker_success(self, mock_sqlite, mock_logger):
    ...
    def test_remove_bad_ticker_failure(self, mock_sqlite, mock_logger):
