...
class TestRedisClientHashOperations:
    ...
    def test_hget_success(self, mock_redis, mock_logger):
        ...
        mock_redis['client'].hget.assert_called_once_with(
            'test_namespace:hash_key', 'field_name'
        )
    ...
    def test_hmset_success(self, mock_redis, mock_logger):
        ...
        assert result is True
        mock_redis['client'].hmset.assert_called_once_with(
            'test_namespace:hash_key', mapping
        )
...
class TestRedisClientListOperations:
    ...
    def test_lrange_success(self, mock_redis, mock_logger):
        ...
        mock_redis['client'].lrange.assert_called_once_with(
            'test_namespace:list_key', 0, -1
        )
