vim.keymap.set('n', '<M-b>', vim.cmd.Ex, { desc = 'Open netrw' }) -- keybind: n <M-b>|Open netrw file explorer
...
vim.api.nvim_create_autocmd('FileType', {
  ...
  callback = function(args)
    ...
    vim.keymap.set('n', '<leader>td', function() -- keybind: n <leader>td|Insert timestamp (date) in markdown
    ...
    vim.keymap.set('n', '<leader>ts', function() -- keybind: n <leader>ts|Insert timestamp (date + time) in markdown
